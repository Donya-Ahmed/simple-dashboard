    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          side === "left"
            ? "left-0 group-data-[state=collapsed]:-left-[calc(var(--sidebar-width))]"
            : "right-0 group-data-[state=collapsed]:-right-[calc(var(--sidebar-width))]",
          className
        )}
        {...props}
      >
...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-auto group-data-[collapsible=icon]:overflow-hidden py-14 px-6",
        className
      )}
      {...props}
    />
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0 h-auto",
        className
      )}
      {...props}
    />
